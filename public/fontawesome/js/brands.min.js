...
!(function () {
   ...
   t[m] = { ...t[m], "fa-kit": "fak" };
   L(t), L({ classic: { 900: "fas", 400: "far", normal: "far", 300: "fal", 100: "fat" }, sharp: { 900: "fass", 400: "fasr", 300: "fasl", 100: "fast" }, "sharp-duotone": { 900: "fasds" } });
   const o = new Set();
   ...
   function u(c, l, z) {
      var { skipHooks: h = !1 } = 2 < arguments.length && void 0 !== z ? z : {},
         z = n(l);
      "function" != typeof d.hooks.addPack || h ? (d.styles[c] = { ...(d.styles[c] || {}), ...z }) : d.hooks.addPack(c, n(l)), "fas" === c && u("fa", l);
   }
   var b = {
      monero: [
         496,
