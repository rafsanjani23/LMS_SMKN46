...
!(function () {
   ...
   D({ classic: { 900: "fas", 400: "far", normal: "far", 300: "fal", 100: "fat" }, sharp: { 900: "fass", 400: "fasr", 300: "fasl", 100: "fast" }, "sharp-duotone": { 900: "fasds" } });
   ...
   function Ct(t, e, a) {
      var { skipHooks: n = !1 } = 2 < arguments.length && void 0 !== a ? a : {},
         a = Pt(e);
      "function" != typeof gt.hooks.addPack || n ? (gt.styles[t] = { ...(gt.styles[t] || {}), ...a }) : gt.hooks.addPack(t, Pt(e)), "fas" === t && Ct("fa", e);
   }
   ...
   const Yt = () => {
      ...
      t = At(
         ...
         (t, e) => {
            ...
            e = e[2];
            return (
               "far" !== n || r || (n = "fas"), "string" == typeof a && (t.names[a] = { prefix: n, iconName: e }), "number" == typeof a && (t.unicodes[a.toString(16)] = { prefix: n, iconName: e }), t
            );
         },
         { names: {}, unicodes: {} },
      );
   ...
   function qt(t, e) {
      const { skipLookups: r = !1 } = 1 < arguments.length && void 0 !== e ? e : {},
         i = { classic: "".concat(et.cssPrefix, "-").concat(l), sharp: "".concat(et.cssPrefix, "-").concat(d), "sharp-duotone": "".concat(et.cssPrefix, "-").concat(p) };
      let o = null,
         s = l;
   ...
   function ie(t) {
      ...
      let h = {
         children: [],
         attributes: { ...f.attributes, "data-prefix": n, "data-icon": r, class: t, role: f.attributes.role || "img", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 ".concat(m, " ").concat(d) },
      };
      m = p && !~f.classes.indexOf("fa-fw") ? { width: "".concat((m / d) * 16 * 0.0625, "em") } : {};
      u && (h.attributes[C] = ""),
         s && (h.children.push({ tag: "title", attributes: { id: h.attributes["aria-labelledby"] || "title-".concat(l || ot()) }, children: [s] }), delete h.attributes.title);
      const g = { ...h, prefix: n, iconName: r, main: e, mask: a, maskId: c, transform: i, symbol: o, styles: { ...m, ...f.styles } };
      var { children: d, attributes: m } = a.found && e.found ? $t("generateAbstractMask", g) || { children: [], attributes: {} } : $t("generateAbstractIcon", g) || { children: [], attributes: {} };
      return (
         (g.children = d),
         (g.attributes = m),
         (o
         ...
         ((l.transform = (function (t) {
            ...
            return (
               t && u
                  ...
                  : (r += t ? "translate(calc(-50% + ".concat(e.x / nt, "em), calc(-50% + ").concat(e.y / nt, "em)) ") : "translate(".concat(e.x / nt, "em, ").concat(e.y / nt, "em) ")),
      ...
      replace: function (t) {
         ...
         e.parentNode &&
            ...
            null === e.getAttribute(C) && et.keepOriginalSource
               ? ((t = w.createComment(((t = e), (t = " ".concat(t.outerHTML, " ")), (t = "".concat(t, "Font Awesome fontawesome.com "))))), e.parentNode.replaceChild(t, e))
               : e.remove());
      },
      nest: function (t) {
         const e = t[0],
         ...
         if ((delete a[0].attributes.id, a[0].attributes.class)) {
            const r = a[0].attributes.class.split(" ").reduce((t, e) => ((e === et.replacementClass || e.match(n) ? t.toSvg : t.toNode).push(e), t), { toNode: [], toSvg: [] });
            ...
            st(t).forEach((t) => {
               ...
               "childList" === t.type && 0 < t.addedNodes.length && !ge(t.addedNodes[0]) && (et.searchPseudoElements && s(t.target), i(t.target)),
                  ...
                  "attributes" === t.type &&
                     ...
                     ("class" === t.attributeName && ((a = t.target), (n = a.getAttribute ? a.getAttribute(M) : null), (a = a.getAttribute ? a.getAttribute(z) : null), n && a)
   ...
   function Fe(t) {
      ...
      const { transform: a = rt, symbol: n = !1, mask: r = null, maskId: i = null, title: o = null, titleId: s = null, classes: c = [], attributes: l = {}, styles: f = {} } = e;
      if (t) {
         ...
         return re(
            ...
            () => (
               ...
               et.autoA11y && (o ? (l["aria-labelledby"] = "".concat(et.replacementClass, "-title-").concat(s || ot())) : ((l["aria-hidden"] = "true"), (l.focusable = "false"))),
               ie({
      ...
      provides(t) {
         (t.i2svg = function (t) {
            ...
            (t.generateSvgReplacementMutation = function (n, t) {
               ...
               return new Promise((a, t) => {
                  Promise.all([fe(r, s), e.iconName ? fe(e.iconName, e.prefix) : Promise.resolve({ found: !1, width: 512, height: 512, icon: {} })])
                     .then((t) => {
                        var [e, t] = t;
                        a([n, ie({ icons: { main: e, mask: t }, prefix: s, iconName: r, transform: c, symbol: l, maskId: f, title: i, titleId: o, extra: u, watchable: !0 })]);
                     })
                     .catch(t);
               });
            }),
            (t.generateAbstractIcon = function (t) {
               ...
               let o;
               return (
                  ut(r) && (o = $t("generateAbstractTransformGrouping", { main: n, transform: r, containerWidth: n.width, iconWidth: n.width })), e.push(o || n.icon), { children: e, attributes: a }
               );
            });
      },
   }),
                  ...
                  return re(
                     ...
                     () => (
                        ...
                        (function (t) {
                           ...
                           const i = [];
                           return i.push({ tag: "span", attributes: r, children: [e] }), a && i.push({ tag: "span", attributes: { class: "sr-only" }, children: [a] }), i;
            ...
            return {
               text(t) {
                  ...
                  return re(
                     ...
                     () => (
                        Zt("beforeDOMElementCreation", { content: t, params: e }),
                        oe({ content: t, transform: { ...rt, ...a }, title: n, extra: { attributes: i, styles: o, classes: ["".concat(et.cssPrefix, "-layers-text"), ...r] } })
                     ),
                  );
               },
            };
      ...
      return new Promise((i, e) => {
         ...
         if (c && "none" !== m && "" !== m) {
            ...
            var { value: d, isSecondary: p } =
                  ...
                  (l = (f = d).length),
                  (h =
                     (p = 55296 <= (h = f.charCodeAt(u)) && h <= 56319 && u + 1 < l && 56320 <= (p = f.charCodeAt(u + 1)) && p <= 57343 ? 1024 * (h - 55296) + p - 56320 + 65536 : h) >= Re[0] &&
                     p <= Re[1]),
            ...
            if (
               (h &&
                  ...
                  (d = Rt[h]),
                  (h = Ht("fas", h)),
                  (h = d || (h ? { prefix: "fas", iconName: h } : null) || { prefix: null, iconName: null }).iconName && h.prefix && ((t = h.iconName), (n = h.prefix))),
            ...
            provides(t) {
               t.generateAbstractTransformGrouping = function (t) {
                  ...
                  return {
                     tag: "g",
                     attributes: { ...o },
                     children: [{ tag: "g", attributes: { ...s }, children: [{ tag: e.icon.tag, children: e.icon.children, attributes: { ...e.icon.attributes, ...c } }] }],
                  };
               };
            },
         },
               ...
               t.generateAbstractMask = function (t) {
                  ...
                  var { width: l, icon: f } = r,
                     u = (function (t) {
                        ...
                        return { outer: r, inner: { transform: "".concat(t, " ").concat(a, " ").concat(e) }, path: { transform: "translate(".concat((n / 2) * -1, " -256)") } };
                     ...
                     u = "mask-".concat(i || ot()),
                     l = "clip-".concat(i || ot()),
                     t = { tag: "mask", attributes: { ...Xe, id: u, maskUnits: "userSpaceOnUse", maskContentUnits: "userSpaceOnUse" }, children: [m, t] },
                     t = { tag: "defs", children: [{ tag: "clipPath", attributes: { id: l }, children: "g" === (f = f).tag ? f.children : [f] }, t] };
                  return e.push(t, { tag: "rect", attributes: { fill: "currentColor", "clip-path": "url(#".concat(l, ")"), mask: "url(#".concat(u, ")"), ...Xe } }), { children: e, attributes: a };
               };
            },
         },
         {
