...
!(function () {
   ...
   var z = c,
      a = l,
      L = (z.document, !a.documentElement || !a.head || "function" != typeof a.addEventListener || a.createElement, ~s.indexOf("MSIE") || s.indexOf("Trident/"), "classic"),
   ...
   d[L] = { ...d[L], "fa-kit": "fak" };
   C(d), C({ classic: { 900: "fas", 400: "far", normal: "far", 300: "fal", 100: "fat" }, sharp: { 900: "fass", 400: "fasr", 300: "fasl", 100: "fast" }, "sharp-duotone": { 900: "fasds" } });
   const u = new Set();
   Object.keys(r[L]).map(u.add.bind(u)), Object.keys(r.sharp).map(u.add.bind(u)), Object.keys(r["sharp-duotone"]).map(u.add.bind(u));
   const h = z || {};
   h[a] || (h[a] = {}), h[a].styles || (h[a].styles = {}), h[a].hooks || (h[a].hooks = {}), h[a].shims || (h[a].shims = []);
   var g = h[a];
   function A(z) {
   ...
   function p(c, l, s) {
      var { skipHooks: z = !1 } = 2 < arguments.length && void 0 !== s ? s : {},
         s = A(l);
      "function" != typeof g.hooks.addPack || z ? (g.styles[c] = { ...(g.styles[c] || {}), ...s }) : g.hooks.addPack(c, A(l)), "fas" === c && p("fa", l);
   }
   var k = {
      "trash-can": [
         448,
