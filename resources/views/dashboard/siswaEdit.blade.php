...
<div class="max-w-2xl mx-auto mt-10">
    ...
    <div class="bg-white shadow-xl rounded-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-indigo-600 to-blue-900 p-6">
            <h2 class="text-3xl font-bold text-center text-white">Edit Data Student</h2>
            <p class="text-center text-indigo-200 mt-2">Fill in the details to change a student data</p>
        </div>
        <!-- Form Container -->
        <div class="p-6">
            <form action="{{ route('students.update', $users->id) }}" method="post" class="space-y-6">
                @csrf
                <!-- Fullname -->
                <div class="relative">
