	...
	<div class="sm:p-6 p-4 mb-8">
		<div class="max-w-5xl w-full bg-white mx-auto rounded-md">
			<div class="pt-7">
				...
				<form action="/teacher/complete-profile-post" method="post" class="px-7" enctype="multipart/form-data"
					...
					<div class="grid grid-cols-1 sm:grid-cols-2 gap-8 text-xl ">
						...
						<div class="flex flex-col justify-center gap-3 text-xl relative">
